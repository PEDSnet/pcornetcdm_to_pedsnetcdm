CREATE table CDMH_STAGING.p2o_code_xwalk_standard(CDM_TBL character varying(50), src_code character varying(256),
src_code_type text, src_vocab_code text, source_code text, source_code_concept_id integer, source_code_description text,
source_vocabulary_id text, source_domain_id text, target_concept_id text, target_concept_name text, target_vocabulary_id text, target_domain_id text, 
...
COMMIT;
 ...
 INSERT INTO CDMH_STAGING.p2o_code_xwalk_standard ( CDM_TBL, src_code, src_code_type, src_vocab_code, 
    ...
    WITH CTE_VOCAB_MAP AS 
        ...
        SELECT distinct 'DIAGNOSIS' as CDM_TBL, d.dx as src_code, d.dx_type as src_code_type,
...
INSERT INTO CDMH_STAGING.p2o_code_xwalk_standard ( CDM_TBL, src_code, src_code_type, src_vocab_code, 
    ...
    raise notice '% PCORnet p2o_code_xwalk_standard table built successfully.', RECORDCOUNT; 
--
    commit ;
