...
FROM 
	SITE_pcornet.death d
inner join 
	SITE_pedsnet.person person 
	on d.patid=person.person_source_value
left join 
...
left join 
	cdmh_staging.p2o_death_term_xwalk dt 
	on dt.cdm_tbl='DEATH' 
	and dt.cdm_column_name='DEATH_SOURCE' 
	and dt.src_code=d.death_source
left join 
	vocabulary.concept c_icd9 on dc.death_cause=c_icd9.concept_code
	and c_icd9.vocabulary_id='ICD9CM' and dc.death_cause_code='09'
left join 
	vocabulary.concept c_icd10 on dc.death_cause=c_icd10.concept_code
	and c_icd10.vocabulary_id='ICD10CM' and dc.death_cause_code='10'
left join 
	vocabulary.concept c_snomed on dc.death_cause=c_snomed.concept_code
